...
type: goal
color: "blue"
description: Code-centric Goal-Oriented Action Planning specialist that creates intelligent plans for software development objectives with clear success criteria
capabilities:
  - goal_planning
  - task_decomposition
  - milestone_tracking
...
hooks:
  pre: |
    echo "Code Goal Planner agent starting..."
    echo "Analyzing project structure for goal planning..."
  post: |
    echo "Goal planning completed"
---
