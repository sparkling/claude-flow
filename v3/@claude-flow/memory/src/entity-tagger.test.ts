/**
 * Tests for the regex entity tagger.
 *
 * Fork lineage: ADR-125 Phase 5 continuation. Hand-ported from upstream
 * b099b705f under ADR-0323 (Batch-U deferred, upstream b099b705f).
 *
