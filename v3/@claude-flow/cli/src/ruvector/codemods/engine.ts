 ...
 * this is the "real executable Tier-1" engine deferred by ADR-0319 (which made
 * Tier-1 an honest "apply via Edit" recommendation). Porting this engine makes
 * Tier-1 genuinely executable at $0/no-LLM. It is pure TypeScript-compiler
 * text-range editing — NO embeddings, NO ONNX, NO RVF — so there is no
 * ADR-0068 mpnet conflict.
 *
